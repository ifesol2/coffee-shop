        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl font-bold text-gray-900">Coffee Shop</h1>
                </div>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                Welcome to
                <span class="bg-gradient-to-r from-blue-600 to-indigo-600 text-transparent bg-clip-text">Coffee Shop</span>
            </h1>
            <p class="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                A nice modern landing page for my local coffee shop to see how many users are going to sign up as they register with their email...
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="col-span-2">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-bold">Coffee Shop</h3>
                    </div>
